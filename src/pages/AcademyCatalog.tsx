...
import type {
  AcademyCatalogItem,
  TutorialMeta,
  TutorialSectionSeparator,
} from "../types";

function isSectionSeparator(
  item: AcademyCatalogItem
): item is TutorialSectionSeparator {
  ...
  return (
    <div className="md:col-span-2 pt-6 first:pt-0">
      <div className="flex items-center gap-4">
        <h2 className="text-2xl font-semibold text-[#292524] dark:text-[#fafaf9]">
          {section.title}
        </h2>
      ...
      {section.description && (
        <p className="mt-2 text-sm text-[#78716c] dark:text-[#a8a29e] max-w-2xl">
          {section.description}
        </p>
      )}
    </div>
  ...
  return (
    ...
    >
      <div className="archival-card group-hover:border-[#c2410c] transition-colors">
        <span className="text-sm font-mono text-[#78716c] dark:text-[#a8a29e] block mb-2">
          {tutorial.date}
        </span>
...
export default function AcademyCatalog() {
  return (
    <div className="flex flex-col gap-10">
      <header>
        <h1 className="text-4xl font-semibold mb-4 text-[#292524] dark:text-[#fafaf9]">
          Open Academy
        </h1>

        <p className="text-lg text-[#44403c] dark:text-[#d6d3d1]">
          Interactive visual guides to complex systems, machine learning, and
          mathematics.
        </p>
      </header>
